...
sudo mariadb -proot --execute="CREATE USER 'ahmed'@'%' IDENTIFIED BY 'mahfouz123'; GRANT ALL PRIVILEGES ON employees.* TO 'ahmed'@'%';"
sudo mariadb -proot --execute="FLUSH PRIVILEGES;"
